 ...
 * Use the {@link ComboGroup_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ComboGroup_Fragment extends Fragment {
    ...
    public static ComboGroup_Fragment newInstance(String param1, String param2) {
        ComboGroup_Fragment fragment = new ComboGroup_Fragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        foodDAO.selectAll(new OnDataLoadedCallbackFood() {
            ...
            public void onDataLoaded(ArrayList<Food> Foods) {
                ...
                customAdapterFood = new CustomAdapterListViewFood(getContext(), R.layout.layout_food_item,  foodBUS.getFoodByCategory("CxnMH5jmmCKZwJtAYHHl"));
                listViewCombo2Food.setAdapter(customAdapterFood);
            }
