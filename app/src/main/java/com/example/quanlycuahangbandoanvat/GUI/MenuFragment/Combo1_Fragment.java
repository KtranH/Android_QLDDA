 ...
 * Use the {@link Combo1_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Combo1_Fragment extends Fragment {
    ...
    public static Combo1_Fragment newInstance(String param1, String param2) {
        Combo1_Fragment fragment = new Combo1_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_combo1_, container, false);
    }

    // khai báo biến
    ListView listViewCombo1Food;
...
//        // ánh xạ ID
//        listViewCombo1Food = (view).findViewById(R.id.listViewCombo1Food);
//
...
//
//                // init listview
//                listFoodByCategory.addAll(foodBUS.getFoodByCategory("NlaAib5qSvVISigYq2tQ"));
//                customAdapterFood = new CustomAdapterListViewFood(getContext(), R.layout.layout_food_item, listFoodByCategory);
//                listViewCombo1Food.setAdapter(customAdapterFood);
//            }
//            @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        foodDAO.selectAll(new OnDataLoadedCallbackFood() {
            ...
            public void onDataLoaded(ArrayList<Food> Foods) {
                ...
                customAdapterFood = new CustomAdapterListViewFood(getContext(), R.layout.layout_food_item,  foodBUS.getFoodByCategory("NlaAib5qSvVISigYq2tQ"));
                listViewCombo1Food.setAdapter(customAdapterFood);
            }
