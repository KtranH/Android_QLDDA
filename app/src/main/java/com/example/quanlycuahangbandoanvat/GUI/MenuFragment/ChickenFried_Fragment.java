 ...
 * Use the {@link ChickenFried_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChickenFried_Fragment extends Fragment {
     ...
     * @return A new instance of fragment ChickenFried_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ChickenFried_Fragment newInstance(String param1, String param2) {
        ChickenFried_Fragment fragment = new ChickenFried_Fragment();
...
//
//                // init listview
//                listFoodByCategory.addAll(foodDAO.getFoodByCategory("nyazUrD8fAxHZISmBH6T",));
...
public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    foodDAO.selectAll(new OnDataLoadedCallbackFood() {
        ...
        public void onDataLoaded(ArrayList<Food> Foods) {
            ...
            customAdapterFood = new CustomAdapterListViewFood(getContext(), R.layout.layout_food_item,  foodBUS.getFoodByCategory("nyazUrD8fAxHZISmBH6T"));
            listViewChickenFriedFood.setAdapter(customAdapterFood);
