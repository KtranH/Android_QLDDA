 ...
 * Use the {@link Burger_Rice_Noodles_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Burger_Rice_Noodles_Fragment extends Fragment {
    ...
    public Burger_Rice_Noodles_Fragment() {
    ...
    public static Burger_Rice_Noodles_Fragment newInstance(String param1, String param2) {
        Burger_Rice_Noodles_Fragment fragment = new Burger_Rice_Noodles_Fragment();
...
//    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        foodDAO.selectAll(new OnDataLoadedCallbackFood() {
            @Override
            public void onDataLoaded(ArrayList<Food> Foods) {
//                nEhiytEQKXzonkg8oEBi
                listFood.addAll(Foods);
                foodBUS = new FoodBUS(listFood);

                customAdapterFood = new CustomAdapterListViewFood(getContext(), R.layout.layout_food_item,  foodBUS.getFoodByCategory("nEhiytEQKXzonkg8oEBi"));
                listViewCombo3Food.setAdapter(customAdapterFood);
            }
