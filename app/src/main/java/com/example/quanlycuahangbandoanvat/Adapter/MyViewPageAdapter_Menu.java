...
import com.example.quanlycuahangbandoanvat.GUI.MenuFragment.Burger_Rice_Noodles_Fragment;
...
import com.example.quanlycuahangbandoanvat.GUI.MenuFragment.ComboGroup_Fragment;
...
public class MyViewPageAdapter_Menu extends  FragmentStatePagerAdapter{
    ...
    public Fragment getItem(int position) {
        switch (position)
        {
            ...
            case 2:
                return  new ComboGroup_Fragment();
            case 3:
                return new Burger_Rice_Noodles_Fragment();
            case 4:
